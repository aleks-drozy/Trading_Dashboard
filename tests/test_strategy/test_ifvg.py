"""
IFVG bar-by-bar tests vs TradingView reference fixtures.
...
def test_ifvg_matches_tradingview(fixture_name):
    ...
    assert mismatches == 0, (
        f"{mismatches} IFVG mismatches vs TradingView in {fixture_name} — "
