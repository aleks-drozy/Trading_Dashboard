...
Logic extracted verbatim from docs/reference/FYP_BOT_1_3.pine.
...
- No inTradingSession gate applied here — state column in fixture is the ground truth.
"""
...
def compute_ifvg(df: pd.DataFrame) -> pd.Series:
    ...
    for i in range(2, n):
        ...
        # --- FVG detection (Pine lines 307-316) ---
